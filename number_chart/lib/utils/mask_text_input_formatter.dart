...
class MaskTextInputFormatter extends TextInputFormatter {
  ...
  MaskTextInputFormatter(
      {String mask = "+# (###) ###-##-##", Map<String, RegExp> filter, int max})
      : assert(mask != null),
  ...
  TextEditingValue updateMask(int max, String mask,
    ...
    _resultTextMasked = "";
    return _formatUpdate(TextEditingValue(), TextEditingValue(
        text: unmaskedText,
        selection: TextSelection(baseOffset: unmaskedText.length,
  ...
  TextEditingValue formatEditUpdate(TextEditingValue oldValue,
    ...
    print("------${newValue.text}");
    if (newValue.text.replaceAll("+84", "0").length > _maxLength) {
      return oldValue;
    }
  ...
  TextEditingValue _formatUpdate(TextEditingValue oldValue,
      TextEditingValue newValue) {
    final selectionBefore = oldValue.selection;

    final String textBefore = oldValue.text;
    final String textAfter = newValue.text.replaceAll("+84", "0");
